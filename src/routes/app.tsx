...
import { useModuleColor } from "@/lib/module-colors";
    ...
    <SidebarProvider>
      <div className="min-h-screen flex w-full bg-cream">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <header className="h-16 bg-white flex items-center justify-between px-4 sticky top-0 z-30" style={{ borderBottom: `3px solid ${moduleColor.accent}` }}>
