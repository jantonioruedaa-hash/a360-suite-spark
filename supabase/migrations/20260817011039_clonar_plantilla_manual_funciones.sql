...
-- Crea función clonar_plantilla_manual_funciones: idempotente, clona las
-- áreas y cargos de la plantilla global al cliente dado.
...
AS $function$
BEGIN
  -- Idempotente: si el cliente ya tiene áreas, no hace nada
...
GRANT EXECUTE ON FUNCTION public.clonar_plantilla_manual_funciones(uuid) TO authenticated, service_role;
